...
dopasowanie2 = re.findall(sciezka,tekst,0)


if dopasowanie: #Sprawdzamy czy udalo sie cos znalezc
    numer = dopasowanie.group()   #Return the string matched by the RE
    print (numer)
...
#RON
abcd = r'Ron'
dop  = re.search(abcd, tekst)
dop2 = re.findall(abcd,tekst,0)

if dop:
    numer2 = dopasowanie.group()
    print (numer2)
...
#HERMIONA
efgh = r'Hermione'
efgh1  = re.search(efgh, tekst)
efgh2 = re.findall(efgh,tekst,0)

if efgh1:
    numer3 = dopasowanie.group()
    print (numer3)

print(efgh2)

print('słowo "Harry" występuje w tekście',len(dopasowanie2),'razy')
print('słowo "Ron" występuje w tekście',len(dop2),'razy')
print('słowo "Hermiona" występuje w tekście',len(efgh2),'razy')

# zadanie nr 1 
# wykorzystując wyrazenie z linii 5 scieżka dopasuj tak wartość aby program zwracał liczbe zaczynająca sie na 2 nastepnie dowolna cyfra a następnie 2 cyfry 1 i dowlona cyfra

# zadanie nr 1 
# wykorzystując wyrazenie z linii 5 scieżka dopasuj tak wartość aby program zwracał liczbe
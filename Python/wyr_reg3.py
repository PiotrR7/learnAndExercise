...
x=(input('podaj szukane słowo: '))




print(szukane_slowo)
wyr_reg="r"+szukane_slowo
dopasowanie  = re.search(r+x )
dopasowanie2 = re.findall(wyr_reg,tekst,0)

if dopasowanie:
    print('słowo',szukane_słowo,'występuje w tekście',len(dopasowanie2),'razy')
